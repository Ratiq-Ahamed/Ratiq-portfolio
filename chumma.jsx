...
const projects = [
  ...
  
  {
    ...
    description: "A Agent which will act like actual sales person to incerase the company profit and customer Satisfaction ",
    link: "#",
    image: "public\\demo.jpg",
  },
  {
    title: "Instruction Pair Gnerator",
    description: "A framework which will convert raw text data into Instruction pair format(can continuously create 100-500 pais from about 400 words raw text )",
    link: "https://github.com/Ratiq-Ahamed/Instruction_pair_dataset",
    image: "/datasetgenerator.png",
  },
]

// const ReadMoreProjects = [
//   {
//     title: "AI Based Calorie Calculator",
//     description: "An intelligent AI Powerd calorie calculator which will calculate the calories based on Natural language.",
//     link: "#",
//     image: "public\\demo.jpg",
//   },
//   {
//     title: "E-Commerce Platform",
//     description: "A sleek online store with a seamless shopping experience.",
//     link: "#",
//     image: "public\\demo.jpg",
//   },
//   {
//     title: "Portfolio Website",
//     description: "A modern personal portfolio to showcase projects and skills.",
//     link: "#",
//     image: "public\\demo.jpg",
//   }
// ]
...
const professionalProjects = [
  {
    ...
    description: "Created a architecture on top of SinGAN and TilingGAN architecture, tuning it to work well on texture generation for games. Which can be attained by single traning image",
    technologies: ["Torch", "CUDA"],
    impact: "Improved the efficieny and quality of 2d texture. Produced diverse variation of texture ensuring the orginal quality remains unchanged",
    period: "2025"
  },
  {
    title: "Full Stach Website with chatbot",
    company: "Ultrakote",
    description: "Designed and developed a responsive, modern website showcasing Ultrakote's comprehensive printing and packagingservices.Integrated a Retrieval-Augmented Generation (RAG) chatbot capable of answering diverse customer queries accurately whileincorporating censorship mechanisms using prompt engineering.",
  ...
  },
  {
    ...
    description: "Fine-tuned a Large Language Model to provide accurate and comprehensive responses regarding ISMO Biophotonics andthe field of biophotonics.",
  ...
  },
  {
    ...
    company: "ISMO Bio-Photionics Pvt Ltd",
    description: "Built a sequential chatbot with a modern user interface to streamline customer interactions, used methods like NLTK andConstructed a simple yet efficient ANN.",
  ...
  **Response Guidelines:**  
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-black via-purple-950 to-black text-white overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-0 md:gap-0">
            ...
            >
              <div className="relative">
                ...
                <div className="relative w-72 h-72 md:w-80 md:h-80 bg-gray-900 rounded-lg overflow-hidden">
                  <img src="/me.jpg" alt="about me" className="rounded-lg object-cover shadow-lg w-full h-full transition-transform duration-300 hover:scale-105 " />
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300 leading-relaxed">
                As a digital craftsman, I blend the precision of code with the artistry of design. With over 1 years of
                experience in creating digital experiences, I prioritize both functionality and aesthetics.
              </p>
              <p className="mt-4 text-gray-300 leading-relaxed">
                My expertise spans AI/ML and  front-end development with stunning Gen AI inegration. I believe in creating
                digital solutions that not only solve problems but also inspire and engage users.
              </p>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                {["React","Framer Motion", "Tailwind CSS", "LangChain","MongoDB","Machine Learning"].map((skill, index) => (
                  <motion.span
                    key={index}
            ...
            {[
              {
                ...
                description: "Led development of enterprise applications using React and Node.js. Implemented AI-driven solutions that improved efficiency by 40%.",
              },
              {
                title: "Data Science",
              ...
              },
              {
                ...
                description: "Built responsive web interfaces and contributed to backend development using modern technologies.",
              },
      ...
      <section id="professional-projects" className="min-h-screen flex flex-col justify-center items-center relative z-10 py-20">
        <motion.div
          className="container mx-auto px-4"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
              ...
              >
                ...
                >
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-purple-300 mt-1">{project.company} • {project.period}</p>
                  </div>
      ...
      {/* Footer Section */}
      <footer className="relative z-10 bg-black/40 backdrop-blur-sm border-t border-purple-500/20 py-16">
        <motion.div 
          className="container mx-auto px-4"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="pt-8 border-t border-purple-500/20">
              <p className="text-gray-400">
                © {new Date().getFullYear()} Ratiq's Portfolio. Thank You For Visiting.
              </p>
            </div>
          </motion.div>
        </motion.div>
